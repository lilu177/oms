...
class Table_Form extends React.Component{
    ...
    renderAdvancedForm(){
        ...
        return(
            <Form className="search-form"  onSubmit={this.handleSearch} id="area">
                <Row gutter={32}>
                ...
                <Row gutter={32}>
                    <Col span={24} style={{ textAlign: 'right' }}>
                        ...
                        <Button style={{ marginLeft: 8 }} onClick={this.handleReset} icon="reload /" >
                            重置
                        </Button>
                        <a style={{ marginLeft: 8, fontSize: 12 }} onClick={this.toggle}>
                            展开 <Icon type={this.state.expandForm ? 'up' : 'down'} />
                        </a>
                    </Col>
                </Row>
            </Form>
            ...
            <Form className="search-form"  onSubmit={this.handleSearch} id="area">
                ...
                <Row gutter={32}>
                    <Col span={24} style={{ textAlign: 'right' }}>
                        ...
                        <a style={{ marginLeft: 8, fontSize: 12 }} onClick={this.toggle}>
                            收起 <Icon type={this.state.expandForm ? 'up' : 'down'} />
                        </a>
                    </Col>
                </Row>
            </Form>
...
export default class smtTable extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
